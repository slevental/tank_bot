 ...
 *  Compilation:  javac org.eslion.IndexMaxPQ.java
 *  Execution:    java org.eslion.IndexMaxPQ
 *
...
/**
 *  The <tt>org.eslion.IndexMaxPQ</tt> class represents an indexed priority queue of generic keys.
 *  It supports the usual <em>insert</em> and <em>delete-the-maximum</em>
 *  operations, along with <em>delete</em> and <em>change-the-key</em> 
 *  methods. org.eslion.In order to let the client refer to items on the priority queue,
...
public class IndexMaxPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
   ...
   /**************************************************************
    * org.eslion.Heap helper functions
    **************************************************************/
