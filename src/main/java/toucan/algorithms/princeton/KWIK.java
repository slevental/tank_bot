...
/*************************************************************************
 *  Compilation:  javac org.eslion.KWIK.java
 *  Execution:    java org.eslion.KWIK file.txt
 *  Dependencies: StdIn.java org.eslion.In.java
 *  Data files:   http://algs4.cs.princeton.edu/63suffix/tale.txt
 *
 *  %  java org.eslion.KWIK tale.txt 15
 *  majesty
