 ...
 *  Compilation:  javac org.eslion.ClosestPair.java
 *  Execution:    java org.eslion.ClosestPair < input.txt
 *  Dependencies: org.eslion.Point2D.java
 *  
            ...
            for (int j = i+1; (j < M) && (aux[j].y() - aux[i].y() < delta); j++) {
                ...
                if (distance < delta) {
                    ...
                    if (distance < bestDistance) {
                        ...
                        best1 = aux[i];
                        best2 = aux[j];
                        // org.eslion.StdOut.println("better distance = " + delta + " from " + best1 + " to " + best2);
                    }
                }
            }
        }
