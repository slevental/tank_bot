...
public class Alphabet {
    ...
    // Create a new org.eslion.Alphabet from chars in string.
    ...
    // Create a new org.eslion.Alphabet of Unicode chars 0 to R-1
    ...
    // Create a new org.eslion.Alphabet of Unicode chars 0 to 255 (extended ASCII)
    public Alphabet() {
        this(256);
    }
    ...
    public char toChar(int index) {
        if (index < 0 || index >= R) {
            throw new RuntimeException("org.eslion.Alphabet out of bounds");
        }
