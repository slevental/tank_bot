...
/*************************************************************************
 *  Compilation:  javac org.eslion.FarthestPair.java
 *  Execution:    java org.eslion.FarthestPair < input.txt
 *  Dependencies: org.eslion.GrahamScan.java org.eslion.Point2D.java
 *  
...
public class FarthestPair {
    ...
    public FarthestPair(Point2D[] points) {
        ...
        int j = k;
        for (int i = 1; i <= k; i++) {
            // org.eslion.StdOut.println("hull[i] + " and " + hull[j] + " are antipodal");
