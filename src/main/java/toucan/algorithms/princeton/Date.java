...
/*************************************************************************
 *  Compilation:  javac org.eslion.Date.java
 *  Execution:    java org.eslion.Date
 *
...
public class Date implements Comparable<Date> {
    ...
    public Date(String date) {
        ...
        if (fields.length != 3) {
            throw new RuntimeException("org.eslion.Date parse error");
        }
    ...
    // return the next org.eslion.Date
    public Date next() {
    ...
    // is this org.eslion.Date after b?
    public boolean isAfter(Date b) {
        return compareTo(b) > 0;
    }

    // is this org.eslion.Date a before b?
    public boolean isBefore(Date b) {
        return compareTo(b) < 0;
    }

    // compare this org.eslion.Date to that one
    ...
    // is this org.eslion.Date equal to x?
