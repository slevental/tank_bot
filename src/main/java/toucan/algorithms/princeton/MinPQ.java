 ...
 *  Compilation:  javac org.eslion.MinPQ.java
 *  Execution:    java org.eslion.MinPQ < input.txt
 *  
 *  Generic min priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order.
 *
 *  % java org.eslion.MinPQ < tinyPQ.txt
 *  E A E (6 left on pq)
 *
...
/**
 *  The <tt>org.eslion.MinPQ</tt> class represents a priority queue of generic keys.
