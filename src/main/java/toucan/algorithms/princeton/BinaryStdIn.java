 ...
 *  Compilation:  javac org.eslion.BinaryStdIn.java
 *  Execution:    java org.eslion.BinaryStdIn < input > output
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java org.eslion.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>org.eslion.BinaryStdIn</tt> with calls
 *  to <tt>org.eslion.StdIn</tt> or <tt>System.in</tt>;
   ...
   /**
    ...
    public static void close() {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Could not close org.eslion.BinaryStdIn");
        }
    }
