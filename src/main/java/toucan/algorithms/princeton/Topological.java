 ...
 *  Dependencies: Digraph.java org.eslion.DepthFirstOrder.java org.eslion.DirectedCycle.java
 *                org.eslion.EdgeWeightedDigraph.java org.eslion.EdgeWeightedDirectedCycle.java
 *  Data files:   http://algs4.cs.princeton.edu/42directed/jobs.txt
 *
 *  Compute topological ordering of a DAG or edge-weighted DAG.
 *  Runs in O(E + V) time.
 *
 *  % java org.eslion.Topological jobs.txt "/"
 *  Calculus
 *  Linear Algebra
 *  Introduction to CS
 *  Programming Systems
