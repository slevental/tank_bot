 ...
 *  Compilation:  javac org.eslion.BinaryIn.java
 *  Execution:    java org.eslion.BinaryIn input output
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java org.eslion.BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 *************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>org.eslion.BinaryIn</tt> with calls
 *  to <tt>org.eslion.In</tt>; otherwise unexpected behavior will result.
 */
