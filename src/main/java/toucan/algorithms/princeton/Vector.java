...
/*************************************************************************
 *  Compilation:  javac org.eslion.Vector.java
 *  Execution:    java org.eslion.Vector
 *
 *  Implementation of a vector of real numbers.
 *
 *  This class is implemented to be immutable: once the client program
 *  initialize a org.eslion.Vector, it cannot change any of its fields
 *  (N or data[i]) either directly or indirectly. Immutability is a
 *  very desirable feature of a data type.
 *
 *  % java org.eslion.Vector
 *     x     = [ 1.0 2.0 3.0 4.0 ]
 *     y     = [ 5.0 2.0 4.0 1.0 ]
 *     z     = [ 6.0 4.0 7.0 5.0 ]
 ...
 * 
 *
 *  Note that org.eslion.Vector is also the name of an unrelated Java library class.
 *
 *************************************************************************/
...
public class Vector { 
    ...
    // org.eslion.Vector x = new org.eslion.Vector(1.0, 2.0, 3.0, 4.0);
    // org.eslion.Vector y = new org.eslion.Vector(5.0, 2.0, 4.0, 1.0);
/*
    public org.eslion.Vector(double... d) {
        N = d.length;
...
*/
    ...
    // return the inner product of this org.eslion.Vector a and b
    ...
    // return the Euclidean norm of this org.eslion.Vector
