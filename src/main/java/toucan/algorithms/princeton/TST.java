...
/*************************************************************************
 *  Compilation:  javac org.eslion.TST.java
 *  Execution:    java org.eslion.TST < words.txt
 *  Dependencies: org.eslion.StdIn.java
 *
 *  Symbol table with string keys, implemented using a ternary search
 *  trie (org.eslion.TST).
 *
 *
 *  % java org.eslion.TST < shellsST.txt
 *  by 4
 *  sea 6
 *  sells 1
 *  she 0
...
public class TST<Value> {
    private int N;       // size
    private Node root;   // root of org.eslion.TST
   ...
   /**************************************************************
    * Find and return longest prefix of s in org.eslion.TST
    **************************************************************/
