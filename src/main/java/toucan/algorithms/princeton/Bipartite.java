...
/*************************************************************************
 *  Compilation:  javac org.eslion.Bipartite.java
 *  Dependencies: org.eslion.Graph.java
 *
...
//                color[v] = false;
    ...
    public static void main(String[] args) {
        ...
        if (b.isBipartite()) {
            StdOut.println("org.eslion.Graph is bipartite");
            for (int v = 0; v < G.V(); v++) {
                StdOut.println(v + ": " + b.color(v));
            }
        }
        else {
            StdOut.print("org.eslion.Graph has an odd-length cycle: ");
            for (int x : b.cycle()) {
                StdOut.print(x + " ");
            }
            StdOut.println();
