 ...
 *  Compilation:  javac org.eslion.EdgeWeightedGraph.java
 *  Execution:    java org.eslion.EdgeWeightedGraph filename.txt
 *  Dependencies: org.eslion.Bag.java org.eslion.Edge.java org.eslion.In.java org.eslion.StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/43mst/tinyEWG.txt
 *
 *  An edge-weighted undirected graph, implemented using adjacency lists.
 *  Parallel edges and self-loops are permitted.
 *
 *  % java org.eslion.EdgeWeightedGraph tinyEWG.txt
 *  8 16
...
/**
 *  The <tt>org.eslion.EdgeWeightedGraph</tt> class represents an undirected graph of vertices
...
public class EdgeWeightedGraph {
   ...
   /**
     ...
     * <tt>for (org.eslion.Edge e : graph.adj(v))</tt>.
     */
   ...
   /**
     ...
     * <tt>for (org.eslion.Edge e : G.edges())</tt>.
     */
