 ...
 *  Compilation:  javac org.eslion.BinaryStdOut.java
 *  Execution:    java org.eslion.BinaryStdOut
 *
 ...
 *  <p>
 *  The client should not intermixing calls to <tt>org.eslion.BinaryStdOut</tt> with calls
 *  to <tt>org.eslion.StdOut</tt> or <tt>System.out</tt>; otherwise unexpected behavior
 *  will result.
 */
