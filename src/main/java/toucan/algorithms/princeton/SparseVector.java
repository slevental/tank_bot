...
/*************************************************************************
 *  Compilation:  javac org.eslion.SparseVector.java
 *  Execution:    java org.eslion.SparseVector
 *  
...
public class SparseVector {
    ...
    public double dot(SparseVector that) {
        if (this.N != that.N) throw new RuntimeException("org.eslion.Vector lengths disagree");
        double sum = 0.0;
