 ...
 *  Compilation:  javac org.eslion.MaxPQ.java
 *  Execution:    java org.eslion.MaxPQ < input.txt
 *  
 *  Generic max priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order,
 *  but the generic Key type must still be Comparable.
 *
 *  % java org.eslion.MaxPQ < tinyPQ.txt
 *  Q X P (6 left on pq)
 *
...
/**
 *  The <tt>org.eslion.MaxPQ</tt> class represents a priority queue of generic keys.
